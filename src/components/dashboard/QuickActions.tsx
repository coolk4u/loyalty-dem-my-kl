  ...
  return (
    <div className="px-6 mb-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Link to="/survey">
          <Button className="glass-card-dark hover:bg-orange-500/20 border border-gray-200 text-gray-900 p-6 h-auto flex-col space-y-3 w-full transition-all duration-300 hover:shadow-enterprise-lg hover:scale-105 group">
            ...
            <span className="font-semibold text-gray-900">Take Survey</span>
          </Button>
        </Link>

        <Link to="/coverage-calculator">
          <Button className="glass-card-dark hover:bg-purple-500/20 border border-gray-200 text-gray-900 p-6 h-auto flex-col space-y-3 w-full transition-all duration-300 hover:shadow-enterprise-lg hover:scale-105 group">
        ...
        <Button className="glass-card-dark hover:bg-indigo-500/20 border border-gray-200 text-gray-900 p-6 h-auto flex-col space-y-3 w-full transition-all duration-300 hover:shadow-enterprise-lg hover:scale-105 group">
        ...
        <Link to="/rewards" className="col-span-2">
          <Button className="glass-card-dark hover:bg-yellow-500/20 border border-gray-200 text-gray-900 p-6 h-auto flex-col space-y-3 w-full transition-all duration-300 hover:shadow-enterprise-lg hover:scale-105 group">
            ...
            <span className="font-semibold text-gray-900">Rewards & Benefits</span>
          </Button>
        </Link>
      </div>
    </div>
